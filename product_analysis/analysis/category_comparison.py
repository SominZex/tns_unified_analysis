...
def category_comparison_analysis(data, selected_categories):
    ...
    chart_type = st.sidebar.selectbox("Select Chart Type", ["Bar Chart", "Pie Chart", "Box Plot"], key="category_comparison_chart_type")
    color_scheme = st.sidebar.color_picker("Select Chart Color", "#3498DB", key="category_comparison_color_picker")
    show_data_labels = st.sidebar.checkbox("Show Data Labels", False, key="category_comparison_show_data_labels")
